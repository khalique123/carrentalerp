...
<td width="80%" valign="top">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="heading_1" style="padding:5px;">Edit Rental Location:</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td valign="top" class="txt_1"  align="center">
                <form  method="POST" action="<?php echo e(route('branch_update_route', ['id' => $branch->id])); ?>" onsubmit="return check_location();"  style="padding-left:5px;">
                    ...
                    <table width="100%" cellpadding="2" cellspacing="4" bgcolor="#f3f3f3">
                        ...
                        <tr>
                            ...
                            <td >
                                <input type="text" name="disp_order" id="disp_order" class="txtbox" value="<?php echo e($branch->display_order); ?>" />
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="loc_name" id="loc_name" class="txtbox" value="<?php echo e($branch->name); ?>" />
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea rows="5" cols="15" name="address" id="address" class="no" placeholder="<?php echo e($branch->address); ?>"></textarea>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="country" id="country" class="no">
                                    ...
                                    <?php if($country->id === $branch->city->state->country->id): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="country" id="country" class="no">
                                    ...
                                    <?php if($state->id === $branch->city->state->id): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="phone" id="phone" class="txtbox" value="<?php echo e($branch->phone_number); ?>" />
                            </td>
                            <td>&nbsp; </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="email" id="email" class="txtbox" value="<?php echo e($branch->email); ?>" />
                            </td>
                            <td>&nbsp; </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="busihour" id="busihour" class="txtbox" value="<?php echo e($branch->business_hours); ?>" />
                            </td>
                            <td>&nbsp; </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea cols="80" id="landmark" name="landmark" rows="10" placeholder="<?php echo e($branch->landmark); ?>"></textarea>
                            </td>
                            <td>&nbsp; </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" size="25" name="gmaplat" id="gmaplat" class="txtbox" value="<?php echo e($branch->latitude); ?>"/>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" size="25" name="gmaplng" id="gmaplng" class="txtbox" value="<?php echo e($branch->longitude); ?>"/>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr >
                        ...
                        <tr>
                            <td>&nbsp;&nbsp;</td>
                            <td>
                                <input type="submit" name="add_loc" value="Save Edit" class="btn_1" />
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
