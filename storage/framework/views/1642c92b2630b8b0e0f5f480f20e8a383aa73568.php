<?php echo $__env->make('header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  <?php echo $__env->make('leftpanel', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></td>
<td width="2%">&nbsp;</td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td valign="top" class="txt_1"  align="center">
                <form  method="POST" action=<?php echo e(route("branch_insert_route")); ?> onsubmit="return check_location();"  style="padding-left:5px;">
