                ...
                <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#7199af" >
                    ...
                    <form  method="POST" action="<?php echo e(route('season_decision_route')); ?>" onsubmit="return check_season();"  style="padding-left:5px;">
                        ...
                        <td colspan="6" width="6%"  align="center" bgcolor="#FFFFFF" >
                            ...
                            <button type="submit" name="deactivate" value="false"><img src="<?php echo e(asset('images/icon_active.gif')); ?>" alt="Deactivate Season" title="Deactivate Season" width="10" height="10" border="0" /></button>
                            <?php else: ?>
                            <button type="submit" name="deactivate" value="true"><img src="<?php echo e(asset('images/icon_close.gif')); ?>" alt="Activate Season" title="Activate Season" width="10" height="10" border="0" /></button>
                            <?php endif; ?>
                        </td>
