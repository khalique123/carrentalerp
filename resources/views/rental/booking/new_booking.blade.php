                    ...
                    <link rel="stylesheet" href="css/bjqs.css" type="text/css">
                        <link href="http://designers.hubspot.com/hs-fs/hub/327485/file-2054199286-css/font-awesome.css" rel="stylesheet">
                            <link rel="stylesheet" href="jq/jquery-ui.css">
                                ...
                                <script src="{{asset('jq/external/jquery/jquery.js')}}"></script>
                                <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>
                                <script src="{{asset('jq/jquery-ui.js')}}"></script>
                                <script src="{{asset('languages/locales/datepicker-en.js')}}"></script> 
                                </head>
                                                                    ...
                                                                    <div class="j-r_right pull-right clearfix">
                                                                        <div class="btn-group pull-right" style="width:100%;">
                                                                            ...
                                                                            @foreach($branches as $branch)
                                                                                <li><a href="javascript:void(0);">{{$branch->name}}</a>
                                                                                    <div style="display:none;" class="location1">{{$branch->id}}</div>
                                                                                </li>
                                                                                @endforeach
                                                                            ...
                                                                            <input type="text" value="03/09/2017" name="datepicker" class="form-control datepick_bx" id="datepicker" size="12" readonly>
                                                                                <div class="btn-group pull-right">
                                                                                    ...
                                                                                    <ul class="dropdown-menu time_one_drop_ul" role="menu">
                                                                                        ...
                                                                                        @foreach($static_times as $time)
                                                                                        <li><a href="javascript:void(0);">{{$time->time_am_pm_format}}</a><div style="display:none;">{{$time->time_24_hr_format}}</div></li>
                                                                                        @endforeach
                                                                                    </ul>
                                                                                    <select name="ph" id="ph" style="display:none;">
                                                                                        <option value="h" >Time</option>
                                                                                        @foreach($static_times as $time)
                                                                                        <option value="{{$time->time_24_hr_format}}">{{$time->time_am_pm_format}}</option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                                        </div>
                                                                ...
                                                                <div class="j-rates_tbox">
                                                                    ...
                                                                    <div class="j-r_right pull-right">
                                                                        <div class="btn-group pull-right clearfix" style="width:100%;">
                                                                            ...
                                                                            @foreach($branches as $branch)
                                                                                <li><a href="javascript:void(0);">{{$branch->name}}</a><div style="display:none;">{{$branch->id}}</div></li>
                                                                                @endforeach
                                                                            </ul>
                                                                    ...
                                                                    <div class="j-r_right pull-right clearfix">
                                                                        <div class="btn-group pull-right" style="width:100%;">
                                                                            ...
                                                                            <ul class="dropdown-menu driver_country_drop" role="menu">
                                                                                ...
                                                                                <li><a href="javascript:void(0);">{{$country->name}}</a><div style="display:none;">{{$country->id}}</div></li>
                                                                                @endforeach
                                                                            </ul>
