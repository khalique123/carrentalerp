    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td valign="top" class="txt_1"  align="center">
                <form  method="POST" action="{{route('branch_update_route', ['id' => $branch->id])}}" onsubmit="return check_location();"  style="padding-left:5px;">
                    {{csrf_field()}}
                    {{method_field('PUT')}}
                    <table width="100%" cellpadding="2" cellspacing="4" bgcolor="#f3f3f3">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea rows="5" cols="15" name="address" id="address" class="no" placeholder="{{$branch->address}}"></textarea>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="country" id="country" class="no">
                                    ...
                                    @if($country->id === $branch->city->state->country->id)
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="country" id="country" class="no">
                                    ...
                                    @if($state->id === $branch->city->state->id)
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="phone" id="phone" class="txtbox" value="{{$branch->phone_number}}" />
                            </td>
                            <td>&nbsp; </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="email" id="email" class="txtbox" value="{{$branch->email}}" />
                            </td>
                            <td>&nbsp; </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="busihour" id="busihour" class="txtbox" value="{{$branch->business_hours}}" />
                            </td>
                            <td>&nbsp; </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea cols="80" id="landmark" name="landmark" rows="10" placeholder="{{$branch->landmark}}"></textarea>
                            </td>
                            <td>&nbsp; </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" size="25" name="gmaplat" id="gmaplat" class="txtbox" value="{{$branch->latitude}}"/>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" size="25" name="gmaplng" id="gmaplng" class="txtbox" value="{{$branch->longitude}}"/>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr >
