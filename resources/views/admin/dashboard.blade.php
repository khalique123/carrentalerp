            ...
            <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="27%" height="50" align="center" bgcolor="#f4f4f4" style="padding:0px 20px; border:1px solid #e0e0e0;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     <tr>
                    <td width="22%" align="left"><a href={{url("password/change")}}><img src="images/icon_changepassword.gif" alt="Change Password" width="27" height="27" border="0" /></a></td>
                    <td width="78%" class="index_link"><a href={{url("password/change")}}>Change Password</a></td>
                  </tr>
                                 </table></td>
                <td width="4%">&nbsp;</td>
                <td width="35%" bgcolor="#F4F4F4" style="padding:0px 20px; border:1px solid #e0e0e0;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                    <td width="19%" align="left"><a href={{route('branch_list_route')}}><img src="images/icon_mangelocation.gif" alt="Manage Location" width="17" height="32" border="0" /></a></td>
                    <td width="81%" class="index_link"><a href={{route('branch_list_route')}}>Rental Locations</a></td>
                  </tr>
              ...
              <tr>
                <td height="50" bgcolor="#F4F4F4" style="padding:0px 20px; border:1px solid #e0e0e0;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                               ...
                                               <tr>
                    <td width="22%" align="left"><a href="{{route('vehicle_class_list_route')}}"><img src="images/icon_manage_carclass.gif" alt="Manage Vehicle Class" width="30" height="25" border="0" /></a></td>
                    <td width="78%" class="index_link"><a href="{{route('vehicle_class_list_route')}}">Vehicle Classes</a></td>
                  </tr>
                                  </table></td>
                <td>&nbsp;</td>
                ...
                <tr>
                    <td width="20%" align="left"><a href="{{route('accessory_list_route')}}"><img src="images/icon_manageoption.gif" alt="Manage Options" width="27" height="26" border="0" /></a></td>
                    <td width="80%" class="index_link"><a href="{{route('accessory_list_route')}}">Rental Accessories</a></td>
                  </tr>
                ...
                <td bgcolor="#F4F4F4" style="padding:0px 20px; border:1px solid #e0e0e0;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                    <td width="23%" align="left"><a href="{{route('vehicle_list_route')}}"><img src="images/icon_managecar.gif" alt="Manage Vehicle" width="34" height="26" border="0" /></a></td>
                    <td width="77%" class="index_link"><a href="{{route('vehicle_list_route')}}">Manage Vehicles</a></td>
                  </tr>
              ...
              <tr>
                ...
                <td bgcolor="#F4F4F4" style="padding:0px 20px; border:1px solid #e0e0e0;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                    <td width="25%" align="left"><a href="{{route('season_list_route')}}"><img src="images/icon_season.gif" alt="Manage Season" width="29" height="28" border="0" /></a></td>
                    <td width="75%" class="index_link"><a href="{{route('season_list_route')}}">Rental Seasons</a></td>
                  </tr>
