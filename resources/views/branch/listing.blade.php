    ...
    <tr>
      ...
      <td width="18%"  align="left" class="link">
        <div align="right" class="pas-txt">
          <a href="add_location.php?action=add">Add Rental Location</a>
        </div>
      </td>
    </tr>
    <tr>
          ...
          <tr bgcolor="#FFFFFF">
            ...
            <td width="16%"  align="center" bgcolor="#FFFFFF"  class="link_1" >
              <div align="center" class="txt-2">
                <b>
                  <a href="manage_location.php?action=delete&location_id=1"  onclick="javascript:return confirm('Are you sure?')" >Delete</a>
                </b>&nbsp;</div>
            </td>
